...
from model.tfgcn import Encoder, Decoder, Classifer, conv_unit, TaskClassifer, TemporalAlignment, GlobalFeatureExtractor
...
class Model(nn.Module):
    def __init__(self, num_class, num_point, num_person=1, graph=None, i3d_weights=None,
        ...
        self.image_extractor = GlobalFeatureExtractor(in_channels=img_out_channels+pose_out_channels,
                                                      out_channels=512, t=0.5,
        ...
        self.task_head = TaskClassifer(512*2, num_class, (1, 1), padding=(0, 0), stride=(1, 1))
        self.feature = None
        self.tanh = nn.Tanh()
